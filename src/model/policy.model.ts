...
const PolicySchema = new Schema<IPolicy>(
  {
    ...
    policyType: { type: String, enum: ["life", "health", "auto", "home", "business"], required: true },
    ...
    claimsLimit: { type: Number },
    cancellationReason: { type: String },
    auditLogs: [{
      action: { type: String, enum: ["created", "updated", "status changed"], required: true },
